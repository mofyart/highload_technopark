...
|---|---|---|---|
| **Primary — Россия (Москва)** | ≈ 74% | 4 зоны доступности Tier III (MS1, GZ1, ME1, PA2) | Основная масса DAU; требование 152-ФЗ о локализации персональных данных граждан РФ; исторически основная инфраструктура VK (аренда DataPro Авиамоторная → с 2023 собственные ЦОД, до 3–4 новых площадок, ≈ 40 млрд ₽ инвестиций) |
...
> **Примечание.** Топология ДЦ «Облака Mail» публично не раскрывается, поэтому как референс порядка величин используется инфраструктура родственного продукта VK Cloud (IaaS). Зоны доступности VK Cloud по первоисточнику ([cloud.vk.ru — Regions](https://cloud.vk.ru/docs/en/tools-for-using-services/account/concepts/regions)): Москва — 4 зоны (MS1, GZ1, ME1, PA2), Казахстан — 2 зоны (QAZ, KTP). Прочие источники: [bgp.tools/as/47764](https://bgp.tools/as/47764) — AS47764, 13 upstream-провайдеров, вкл. международный (Telia); [vk.company/ru/press/releases/11468](https://vk.company/ru/press/releases/11468/) — запуск региона в Казахстане (QazCloud); [vkcloud.kz/blog](https://vkcloud.kz/blog/vk-tech-zapustila-vtoruyu-zonu-dostupnosti-vk-cloud-v-respublike-kazakhstan/) — вторая зона доступности (KazTeleport, Астана); [anti-malware.ru](https://www.anti-malware.ru/news/2026-05-12-111332/50002) — 4-я зона (PA2) запущена в собственном ЦОД VK (2026); [mforum.ru](http://www.mforum.ru/analit/tsod.htm) — переход VK с арендованных мощностей на строительство собственных ЦОД (2023).
...
2. **Внутри региона (между 4 зонами доступности Москвы) — Weighted Round-Robin DNS** с весами, равными доле ёмкости каждой зоны, либо делегирование на L4/L7 (глава 9, LSLB) — задержка между зонами одного региона мала, поэтому нет смысла терять время на DNS TTL ради выбора конкретной зоны.
