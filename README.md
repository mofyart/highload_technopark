...
1. **Многопоточная загрузка файлов с докачкой.** Клиент разбивает файл на блоки и загружает их параллельно;
2. **Дедупликация на уровне блоков.** Адрес блока данных вычисляется как криптографический хэш его содержимого;
...
5. **Управление дисковой квотой (Mail Space - Оверквота).** Кросс-сервисный микросервис учёта занятого пространства, объединяющий квоты Почты и Облака в единый атомарный счётчик в рамках подписки Mail Space;
