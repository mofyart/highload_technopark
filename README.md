...
> **Параметры расчёта.** DAU = 2,5 млн → множитель `28,94 = 2,5 млн / 86 400`. `K_peak = 4` (пиковый час ≈ 1/6 суток). `N = 1,6` блоков/файл (блок 8 МБ: фото и документы — 1 блок, видео ~12). Разбиение действий §2.1.3: операции ФС 5 = листинг 4 + CRUD 1; публичный доступ 0,2 = создание ссылки 0,05 + доступ 0,15; квота 12 = проверка 6 + обновление 6.
