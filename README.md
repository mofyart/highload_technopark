...
|---|---|---|---|
| Фотографии | 3,3 | 1321 | https://habr.com/ru/news/887932/ — 28 млрд фото = 70 ПБ |
| Видео | — | 118 | https://habr.com/ru/news/887932/ — 2,5 млрд видео (объём не раскрыт) |
| Документы и прочее | — | 708 | вычислено: 45,5 − 28 − 2,5 = 15 млрд (из https://habr.com/ru/news/887932/) |
| **Итого** | 15,8 | 2146 | https://habr.com/ru/news/887932/ — 335 ПБ, 45,5 млрд файлов |

> Расчёт на MAU = 21,2 млн (Россия, Mediascope): `объём/пользователя = объём(тип) / MAU`, `файлов/пользователя = файлы(тип) / MAU` (значения округлены до целых). Объём видео и документов в первоисточнике не раскрыт — оставшиеся 265 ПБ (335 − 70) требуют дооценки.
