...
> **Примечание.** Железно посчитана только строка «Загрузка» (5,8 млрд файлов/год из §1.2). Остальные — оценки: для сервиса-бэкапа скачиваний меньше загрузок, они заданы коэффициентом `скачивания = k × загрузки`, `k = 0,15`; листинг доминирует среди операций ФС; шаринг и авторизация редки. Проверка/обновление квоты привязаны к загрузкам до и после каждого файла.
