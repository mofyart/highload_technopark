...
> **Примечание.** Единицы десятичные: 1 ПБ = 10³ ТБ = 10⁶ ГБ = 10⁹ МБ. Средний размер `= объём / количество`. Фото (28 млрд, 70 ПБ) и итог (45,5 млрд, 335 ПБ) — фактические данные §1.2. Видео и документы — оценки из §2.1.2: объём видео = 335 − 70 − 30 = 235 ПБ (средний ≈ 94 МБ), документы = 15 млрд × 2 МБ = 30 ПБ. Значение 2,0 МБ для документов — само допущение, а не независимое измерение.
